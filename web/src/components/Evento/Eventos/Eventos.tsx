        ...
        <tbody>
          {eventos.map((evento) => (
            <tr key={evento.id}>
              ...
              <td>{truncate(evento.titulo)}</td>
              <td>{truncate(evento.acerca)}</td>
              <td>{truncate(evento.pelo)}</td>
              <td>{truncate(evento.altura)}</td>
              <td>{truncate(evento.sexo)}</td>
              <td>{timeTag(evento.when)}</td>
              <td>{truncate(evento.prerequisitos)}</td>
